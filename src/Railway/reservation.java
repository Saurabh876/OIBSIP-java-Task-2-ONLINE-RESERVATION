...
public class reservation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Passanger No. (PNR)");
        ...
        jButton3.setText("Cancel Reserv");
        ...
        jButton1.getAccessibleContext().setAccessibleName("reserve");
...
pst = (PreparedStatement) con.prepareStatement("select startplace,eplace,tno,tname,price,date,ticket,totals from reserv where pno=?");
        ...
        if(rs.next()==false)
        {
            ...
            txttotal.setText("");
        ...
        else
                {
                    ...
                    txtticket.setText(rs.getString("ticket"));
                    txttotal.setText(rs.getString("totals"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String total  = txttotal.getText();
            ...
            try {
                pst = (PreparedStatement) con.prepareStatement("insert into reserv (pno,startplace,eplace,tno,tname,price,date,ticket,totals) Values(?,?,?,?,?,?,?,?,?)");
            } catch (SQLException ex) {
                Logger.getLogger(reservation.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String total  = txttotal.getText();
            ...
            try {
                pst = (PreparedStatement) con.prepareStatement("delete from reserv where pno=?");
            } catch (SQLException ex) {
                Logger.getLogger(reservation.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        // TODO add your handling code here: search- train
